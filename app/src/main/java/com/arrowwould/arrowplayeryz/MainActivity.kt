...
import com.arrowwould.arrowplayeryz.databinding.ActivityMainBinding
import com.arrowwould.arrowplayeryz.databinding.ThemeViewBinding
...
//            Handler(Looper.getMainLooper()).postDelayed(runnable!!, 0)
        ...
        binding.navView.setNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.verifideNav -> startActivity(Intent(this, VerifyActivity::class.java))
